...
There is not any biological reason to assume the existence of one's self. At the end, personal identity is just a conceptualization, a convenient linear explanation for a non-lineal reality. 

The notion of the self would rather be better understood as a set of parallel processes taking place in a human brain. And actually, mental processes coexist in a permanent conflict, sometimes working as subconscious entities, sometimes coming to the surface of attention. 

Additionally, from a performative perspective, we could tell that subjects are something different that what they perform. Actually, we perform multiple roles and behave differently depending on the social context. Most of our interactions with the environment are a consequence of nurture rather than nature and most of the time we are "identified" as specific "personas" from a behaviorist viewpoint rather than analyzing our complexity as biological and cognitive agents.
...
Self-perception can be understood as an emergent property of a complex biological system, interdependently embedded in an external ecosystem through dynamic interactions. Self-perception could be just a sophisticated process that enhances our adaptability and decision making capabilities, producing as many "personalities" and personal narratives as contexts we need to adapt to. It could also be just an evolutionary artifact, a biologically random accident.


## Looking for Identity

As any other content included in this site, the concept of *identity* does not follow the standardized or generally accepted definition. This *commonplace book* provides a map to navigate a subjective ontology rather than a *knowledge base* built on [consensus](consensus.md).

My current position on personal identity is closer to the one of Thomas Fuchs. However, my quest for the understanding of identity started far beyond this idea. I have actually addressed the quest for the self through different [pathways](pathways.md) (you can read about them in the  [about me](../../about.md) section). For years, I  studied identity formation by following traditional methodologies and formal research. Everything began with mathematical and computational simulations of social behavior, years before I moved towards an ethnographic perspective, based on ethnic and linguistic clusters. I even published a film titled [Looking for Identity](https://youtu.be/1rUHNIJ7rn0) exploring identity-related issues from an ethnographic perspective.

However, this approach inevitably evolved towards pure [phenomenology](phenomenology.md) and introspective self-inquiry. Eventually it lead me to the deconstruction of those lower-case identities, what I refer to like "the characters". I started to understand *identity* as something else, closer to John Locke's foundations about the self. And then, I killed Locke and discovered Hume. 
